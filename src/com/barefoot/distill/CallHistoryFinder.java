...
public class CallHistoryFinder {
  ...
  private List<OutgoingCallRecord> callLogs(PhoneNumber phoneNumber, Date sinceDate) {
    ...
    String columns[]=new String[] { CallLog.Calls.NUMBER, CallLog.Calls.DATE, CallLog.Calls.DURATION, CallLog.Calls.TYPE };
    ...
    Cursor cursor = context.getContentResolver().query(Uri.parse("content://call_log/calls"), columns, selector, selectorArgs.toArray(new String[selectorArgs.size()]), CallLog.Calls.DATE +" DESC");
